<!doctype html>
<html lang="en"><!-- InstanceBegin template="/Templates/two_col_horiz.dwt.php" codeOutsideHTMLIsLocked="false" --> 
...
<!-- InstanceBeginRepeat name="breadcrumb-repeat" --><!-- InstanceBeginRepeatEntry -->		  
                  ...
                  <a href="#" title="">Breadcrumb</a>				  <!-- InstanceEndEditable -->				  <!-- InstanceEndRepeatEntry --><!-- InstanceEndRepeat -->	
                  </li>                 
                  </ul>
                  </div><!-- div#crumbs -->	
					...
					<h1>
					<!-- InstanceBeginEditable name="page_title-editable" -->Example Templated Page					<!-- InstanceEndEditable --></h1>
