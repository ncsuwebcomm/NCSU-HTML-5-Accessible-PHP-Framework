...
<link href="core/css/player.css" media="screen" rel="stylesheet" type="text/css"/>  
...
<script src="core/js/ariaTabs3b.js"></script>  
...
<!-- InstanceParam name="breadcrumbs" type="boolean" value="false" --><!-- InstanceParam name="page_title" type="boolean" value="true" --><!-- InstanceParam name="feature_player" type="boolean" value="true" -->
</head>
        ...
        <div id="middle">
		  ...
		  <?php include('includes/nav-horiz.php'); ?>
                ...
                <h6 class="screen-reader-text">Content</h6>
					...
					<!-- InstanceBeginEditable name="feature_player" -->
