<!doctype html>
<html lang="en"><!-- InstanceBegin template="/Templates/two_col_vert.dwt.php" codeOutsideHTMLIsLocked="false" --> 
...
<!-- InstanceParam name="breadcrumbs" type="boolean" value="true" --><!-- InstanceParam name="page_title" type="boolean" value="true" --><!-- InstanceParam name="feature_player" type="boolean" value="false" -->

</head>

<body id="two_col_vert" class="<?php echo bodyAttributes(); ?>">
